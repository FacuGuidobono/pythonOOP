...
def generar_tablas_multiplicar(n):
    ...
    for i in range(1, n + 1):
        tabla[i] = [i * j for j in range(1, 11)]  
...
def main():
    ...
    n = validacion_un_numero('Ingrese el numero de tablas que quiere generear: ',int)  # Puedes ajustar este valor para obtener más tablas de multiplicar
